...
def image_upload_url(play_id):
    """Return URL for recipe play upload"""
...
class AuthenticatedPlayApiTests(TestCase):
    ...
    def test_filter_plays_by_title(self):
        play1 = sample_play(title="ABAb")
        play2 = sample_play(title="AbdA")
        play3 = sample_play(title="abah")

        res = self.client.get(PLAY_URL, {"title": "aba"})
